...
func (suite *RpcTestSuite) SetupSuite() {
	...
	suite.ExpectedRpcResults = map[string]string{
		...
		"/api/v6/info/nonsense/blubb":                       `{"error":"Incorrect by field specified.","resultcount":0,"results":[],"type":"error","version":6}`,
		...
		"/api/v6/info?by=provides":                          `{"error":"No request data specified.","resultcount":0,"results":[],"type":"error","version":6}`,
		...
		"/api/v6/search/nonsense/attest":           `{"error":"Incorrect by field specified.","resultcount":0,"results":[],"type":"error","version":6}`,
		"/api/v6/search/nonsense/nonsense/attest":  `{"error":"Incorrect by field specified.","resultcount":0,"results":[],"type":"error","version":6}`,
		"/api/v6/search/name/nonsense/attest":      `{"error":"Incorrect mode specified.","resultcount":0,"results":[],"type":"error","version":6}`,
		"/api/v6/search/name/starts-with/nonsense": `{"resultcount":0,"results":[],"type":"search","version":6}`,
		...
		"/api/v6/search/name/starts-with/test":     `{"resultcount":0,"results":[],"type":"search","version":6}`,
		...
		"/api/v6/info?by=provides&arg=awfulness&arg=rollerblades&arg=pastime&arg=bliss&arg=idleness&arg=ambushed&arg=spectate&arg=retakes&arg=tradeswoman&arg=belfries": `{"error":"Too many package results.","resultcount":0,"results":[],"type":"error","version":6}`,
	}
